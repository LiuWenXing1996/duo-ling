...
| [文档规范](content/doc-standard.md) | [docs/doc-standard.md](../docs/doc-standard.md) | 一个事实一个家、写当前状态不写变更史、字数上限 |
...
| 笔记 | 源文档 | 一句话现状 |
| --- | --- | --- |
| [插件迁移方案](content/plugin-migration-plan.md) | [docs/plugin-migration-plan.md](../docs/plugin-migration-plan.md) | Electron → MV3 映射 / 分层 / 风险；迁移已完成（剩 Firefox） |
| [工具链路移除方案](content/tool-chain-removal-plan.md) | [docs/tool-chain-removal-plan.md](../docs/tool-chain-removal-plan.md) | 工具整条链路已移除，扩展只留脚本 + 对话 |
| [代码风格规范](content/style.md) | [docs/style.md](../docs/style.md) | 命名 / TS / Vue / 样式 / shadcn / 测试 / 提交 约定 |
...
| 笔记 | 源文档 | 一句话现状 |
| --- | --- | --- |
| [用户脚本新形态（v2）](content/userscript-v2-plan.md) | [docs/userscript-v2-plan.md](../docs/userscript-v2-plan.md) | 放弃油猴，自有 DL API + 模块化 + 隔离；Phase 0–3 已实施 |
...
| [编辑器草稿方案](content/userscript-draft.md) | [docs/userscript-draft.md](../docs/userscript-draft.md) | 草稿 = 工作区未提交改动，自动落盘、重开恢复 |
| [脚本 Git 历史浏览](content/userscript-git-history.md) | [docs/userscript-git-history.md](../docs/userscript-git-history.md) | 每脚本一仓、状态库权威 git 为侧车，保存自动版本 |
...
| 清单 | 源文档 | 说明 |
| --- | --- | --- |
| 想法收件箱 | [docs/inbox.md](../docs/inbox.md) | 只放问题（≤100 字），无方案、不承诺做 |
| 待办与方案 | [docs/todo.md](../docs/todo.md) | 待办索引，只留链接；方案全文进提案 |
