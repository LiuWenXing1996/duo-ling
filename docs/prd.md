# 哆灵 · 让 AI 帮你打造属于自己的工具箱 · PRD

> Product Requirements Document · V1.1

**哆灵** —— 让 AI 帮你打造属于自己的工具箱：应用自身只有一组「原子能力」积木；用户一句话，AI 连续追问澄清后，把原子能力组合成一个**带界面、可反复使用、可版本回溯的本地工具**；工具出问题或要改需求时，再回来找应用内的 AI 维护。
...
> ⚠️ **2026-09-14 状态补充（重要）**：本文主链路描述的是「一句话 → 生成**工具**」。
> 该「AI 生成工具」链路**已整体下线移除**（老大 2026-09-14 决策），产品方向转为用户脚本
> （一句话 → 生成**用户脚本**，注入第三方页面运行）。移除范围与实施步骤见
> [tool-chain-removal-plan.md](./tool-chain-removal-plan.md)。
> **本文尚未按新方向重写**，涉及「工具生成 / 工具页 / 原子能力组合」的章节仅作历史参照；
> 现有功能以 [userscript-ai-generation.md](./userscript-ai-generation.md) 为准。
> 原子能力、版本回溯等通用机制仍有效，但不再服务于工具形态。
