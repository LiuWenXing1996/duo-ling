// 打开的工作区标签：主页 / 工具 / 设置 / 工具版本历史 / 工具数据详情 / 开发者界面
export type OpenTool = {
  /** 标签唯一标识：主页与设置固定，工具用工具 ID，版本历史用「工具ID:history」，数据用「工具ID:data」 */
  id: string
  title: string
  /** 标签种类：home 渲染工具主页，tool 渲染工具详情，settings 渲染设置面板，tool-history 渲染版本历史，tool-data 渲染数据详情，developer 渲染开发者界面 */
  kind: 'home' | 'tool' | 'settings' | 'tool-history' | 'tool-data' | 'developer'
